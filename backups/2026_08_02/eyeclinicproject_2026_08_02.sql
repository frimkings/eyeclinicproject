...
CREATE TABLE `consultation_notes` (
  ...
  `patient_id` bigint unsigned NOT NULL,
  `user_id` bigint unsigned DEFAULT NULL,
  `note_type` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'clinical_addendum',
...
INSERT INTO `expense_categories` VALUES (1,'Staff Salaries','operating_expense','#3490dc',NULL,1,'2026-08-02 19:56:58','2026-08-02 19:56:58'),(2,'Rent / Utilities','operating_expense','#f6993f',NULL,1,'2026-08-02 19:56:58','2026-08-02 19:56:58'),(3,'Supplies','operating_expense','#38c172',NULL,1,'2026-08-02 19:56:58','2026-08-02 19:56:58'),(4,'Equipment','operating_expense','#9561e2',NULL,1,'2026-08-02 19:56:58','2026-08-02 19:56:58'),(5,'Maintenance','operating_expense','#e3342f',NULL,1,'2026-08-02 19:56:58','2026-08-02 19:56:58'),(6,'Marketing','operating_expense','#ff6384',NULL,1,'2026-08-02 19:56:58','2026-08-02 19:56:58'),(7,'Bank Charges','operating_expense','#6574cd',NULL,1,'2026-08-02 19:56:58','2026-08-02 19:56:58'),(8,'Miscellaneous','operating_expense','#6c757d',NULL,1,'2026-08-02 19:56:58','2026-08-02 19:56:58');
...
INSERT INTO `lens_options` VALUES (1,'Single Vision','SV Clear','2026-08-02 19:57:02','2026-08-02 19:57:02'),(2,'Single Vision','SV Hard Coat','2026-08-02 19:57:02','2026-08-02 19:57:02'),(3,'Single Vision','SV AR','2026-08-02 19:57:02','2026-08-02 19:57:02'),(4,'Single Vision','SV Photo AR','2026-08-02 19:57:02','2026-08-02 19:57:02'),(5,'Single Vision','SV Blue AR','2026-08-02 19:57:02','2026-08-02 19:57:02'),(6,'Single Vision','SV Blue Block','2026-08-02 19:57:02','2026-08-02 19:57:02'),(7,'Single Vision','SV Blue Block Photo','2026-08-02 19:57:02','2026-08-02 19:57:02'),(8,'Single Vision','SV Special Order','2026-08-02 19:57:02','2026-08-02 19:57:02'),(9,'Bifocal','Bifocal Clear','2026-08-02 19:57:02','2026-08-02 19:57:02'),(10,'Bifocal','Bifocal AR','2026-08-02 19:57:02','2026-08-02 19:57:02'),(11,'Bifocal','Bifocal Photo AR','2026-08-02 19:57:02','2026-08-02 19:57:02'),(12,'Bifocal','Bifocal Blue Block','2026-08-02 19:57:02','2026-08-02 19:57:02'),(13,'Bifocal','Special Order Bifocal','2026-08-02 19:57:02','2026-08-02 19:57:02'),(14,'Progressive','Progressive Clear','2026-08-02 19:57:02','2026-08-02 19:57:02'),(15,'Progressive','Progressive AR','2026-08-02 19:57:02','2026-08-02 19:57:02'),(16,'Progressive','Progressive Photo AR','2026-08-02 19:57:02','2026-08-02 19:57:02'),(17,'Progressive','Progressive Blue Block','2026-08-02 19:57:02','2026-08-02 19:57:02'),(18,'Progressive','Progressive Blue Block Photo','2026-08-02 19:57:02','2026-08-02 19:57:02'),(19,'Progressive','Special Order Progressive','2026-08-02 19:57:02','2026-08-02 19:57:02');
...
CREATE TABLE `patients` (
  ...
  `insurance_member_name` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `referral_snippets` VALUES (1,'referral','reasonForReferral','Specialist Review','Kindly review for further ophthalmic evaluation and management.',1,NULL,'2026-08-02 19:56:52','2026-08-02 19:56:52'),(2,'referral','management','Initial Treatment Given','Initial treatment and counselling have been provided. Patient has been advised to report for specialist care.',1,NULL,'2026-08-02 19:56:52','2026-08-02 19:56:52'),(3,'medical_report','recommendation','Follow-up Recommended','The patient is advised to continue treatment and attend scheduled follow-up appointments.',1,NULL,'2026-08-02 19:56:52','2026-08-02 19:56:52'),(4,'medical_report','clinicalFindings','Clinical Summary','Clinical examination was performed and findings are consistent with the stated diagnosis.',1,NULL,'2026-08-02 19:56:52','2026-08-02 19:56:52'),(5,'excuse_duty','diagnosis','Medical Rest','Patient requires temporary rest from work or school duties for medical reasons.',1,NULL,'2026-08-02 19:56:52','2026-08-02 19:56:52');
...
CREATE TABLE `referrals` (
  ...
  `excuse_notes` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `refund_logs` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `sale_id` bigint unsigned NOT NULL,
  `refund_number` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `request_type` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'refund',
  ...
  `original_payment_references` json DEFAULT NULL,
  `stock_restoration` json DEFAULT NULL,
  `rejection_reason` text COLLATE utf8mb4_unicode_ci,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `refund_logs_refund_number_unique` (`refund_number`),
...
CREATE TABLE `report_deliveries` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `delivery_key` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `sms_templates` VALUES (1,'appointment_booking','Appointment Booking Confirmation','Hello [NAME], your appointment at [CLINIC] is confirmed for [DATE] at [TIME] – [REASON].','[\"[NAME]\", \"[DATE]\", \"[TIME]\", \"[REASON]\", \"[CLINIC]\"]','2026-08-02 19:56:56','2026-08-02 19:56:56'),(2,'appointment_reminder','Appointment Reminder','Hello [NAME], this is a reminder of your appointment at [CLINIC] on [DATE] at [TIME] – [REASON]. Please be on time.','[\"[NAME]\", \"[DATE]\", \"[TIME]\", \"[REASON]\", \"[CLINIC]\"]','2026-08-02 19:56:56','2026-08-02 19:56:56'),(3,'spectacles_ready','Spectacles Ready for Pickup','Hello [NAME], your spectacles (Order [ORDER_ID]) are ready for collection at [CLINIC]. Please bring this message when you come in.','[\"[NAME]\", \"[ORDER_ID]\", \"[CLINIC]\"]','2026-08-02 19:56:56','2026-08-02 19:56:56'),(4,'spectacles_reminder','Spectacles Pickup Reminder','Hello [NAME], your spectacles (Order [ORDER_ID]) are still waiting for collection at [CLINIC]. Please come in at your earliest convenience.','[\"[NAME]\", \"[ORDER_ID]\", \"[CLINIC]\"]','2026-08-02 19:56:56','2026-08-02 19:56:56'),(5,'payment_receipt','Payment Receipt','Hello [NAME], payment of GHS [AMOUNT] received at [CLINIC]. Transaction: [TXN_ID]. Thank you!','[\"[NAME]\", \"[AMOUNT]\", \"[TXN_ID]\", \"[CLINIC]\"]','2026-08-02 19:56:56','2026-08-02 19:56:56'),(6,'birthday_wishes','Birthday Wishes','Happy Birthday [NAME]! Wishing you good health and clear vision. From all of us at [CLINIC].','[\"[NAME]\", \"[CLINIC]\"]','2026-08-02 19:56:56','2026-08-02 19:56:56'),(7,'custom_broadcast','Custom Broadcast','Dear [NAME], [CLINIC] wishes you a joyful [OCCASION]! Thank you for trusting us with your eye care.','[\"[NAME]\", \"[CLINIC]\", \"[OCCASION]\"]','2026-08-02 19:56:56','2026-08-02 19:56:56'),(8,'patient_recall','Patient Recall','Hello [NAME], it\'s been a while since your last visit to [CLINIC]. Your eyes deserve regular care — book your next check-up today. Call us anytime!','[\"[NAME]\", \"[CLINIC]\"]','2026-08-02 19:56:56','2026-08-02 19:56:56'),(9,'appointment_auto_reminder','Appointment Auto-Reminder','Hello [NAME], this is a reminder of your appointment at [CLINIC] tomorrow, [DATE] at [TIME]. Please call us if you need to reschedule.','[\"[NAME]\", \"[CLINIC]\", \"[DATE]\", \"[TIME]\"]','2026-08-02 19:56:56','2026-08-02 19:56:56'),(10,'spectacle_renewal','Spectacle Renewal Reminder','Dear [NAME], your spectacles are due for renewal on [DATE]. Please visit [CLINIC] for your annual eye review.','[\"[NAME]\", \"[DATE]\", \"[CLINIC]\"]','2026-08-02 19:56:57','2026-08-02 19:56:57');
...
-- Dump completed on 2026-08-02 20:00:20
