<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('doctor.dashboard')}}" class="nav-link success">Doctor</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('secretary.dashboard')}}" class="nav-link primary">Secretary</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('admin.dashboard')}}" class="nav-link primary">Admin</a>
      </li>
        <li class="nav-item d-none d-sm-inline-block">
