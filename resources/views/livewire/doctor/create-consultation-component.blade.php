                ...
                <history>
                    <div class="row">
                        <div class="form-floating col-12">
                            <textarea wire:model="state.chiefComplaint" class="form-control" required
                ...
                <div class="modal-body">
                    ...
                    <div class="row lens-order">
                        ...
                        <div class="col-4">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" wire:model="specs.otherSpecs">
                            </div>
                        </div>
                        <input type="text" class="form-control form-control-sm" id="colFormLabelSm"
                            wire:model="specs.patient_id" placeholder="col-form-label-sm"
